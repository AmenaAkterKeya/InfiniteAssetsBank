...
def transfer_amount(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            send_transaction_email(request.user, amount, "Transfer Sent", "transactions/transfer_sent_email.html")
            send_transaction_email(to_account.user, amount, "Transfer Received", "transactions/transfer_received_email.html")
        else:
